 ...
 */
static tjs_error evalJSON(tTJSVariant *result, tjs_int numparams, tTJSVariant **param)
{
	if (numparams < 1)
	{
 ...
 */
static tjs_error evalJSONStorage(tTJSVariant* result, tjs_int numparams, tTJSVariant** param)
{
	if (numparams < 1)
	{
		return TJS_E_BADPARAMCOUNT;
 ...
 *
 */
static tjs_error saveJSON(tTJSVariant* result, tjs_int numparams, tTJSVariant** param)
{
	if (numparams < 2)
	{
		return TJS_E_BADPARAMCOUNT;
 ...
 *
 */
tjs_error toJSONString(tTJSVariant *result, tjs_int numparams, tTJSVariant **param)
{
	if (numparams < 1)
	{
		return TJS_E_BADPARAMCOUNT;
...
{
	return
		(SimpleBinder::BindUtil(TJS_W("Scripts"), link)
			.Function(TJS_W("evalJSON"), &evalJSON)
			.Function(TJS_W("evalJSONStorage"), &evalJSONStorage)
			.Function(TJS_W("saveJSON"), &saveJSON)
			.Function(TJS_W("toJSONString"), &toJSONString)
			.IsValid()
		);
}
